...
const CTA = () => (
  <section
    className={`flex justify-center items-center  sm:my-16 my-6}  sm:px-16 px-6 sm:py-12 py-4} sm:flex-row flex-col bg-[#141414]-gradient-2 rounded-[20px] box-shadow`}
  >
